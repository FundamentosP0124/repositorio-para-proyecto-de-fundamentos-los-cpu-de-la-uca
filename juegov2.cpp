...
void jugar(const string &palabra)
{
    ...
    while (intentos < MAX_INTENTOS)
    {
        ...
        {
            cout << "¡Felicidades! Has ganado. La palabra era " << palabra << "BIEN JUGADO" << endl;
            return;
        }
    }

    cout << "¡Lo siento! Has perdido. La palabra era: " << palabra << "Mas suerte para la proxima" << endl;
}
