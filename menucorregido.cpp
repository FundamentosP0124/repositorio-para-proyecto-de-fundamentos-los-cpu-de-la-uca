...
int main(){
    ...
    cin >> nickname;
   do{
    cout << "\n Bienvenidos al juego del ahorcado "<< nickname << " selecciona la dificultad, si necesitas ayuda para comprender el juego aqui te va una pequeña ayuda de que va la cosa" << endl;
